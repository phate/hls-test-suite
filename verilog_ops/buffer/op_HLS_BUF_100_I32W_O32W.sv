...
module op_HLS_BUF_100_I32W_O32W_ram_100x32(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [6:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [31:0] R0_data,
...
module op_HLS_BUF_100_I32W_O32W_Queue100_UInt32(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_100_I32W_O32W_ram_100x32 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? (deq_ptr_value == 7'h63 ? 7'h0 : deq_ptr_value + 7'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .R0_data (io_deq_bits),
...
module op_HLS_BUF_100_I32W_O32W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  input  [31:0] i0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:524:14
  ...
  output [31:0] o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:525:14
  ...
  op_HLS_BUF_100_I32W_O32W_Queue100_UInt32 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
