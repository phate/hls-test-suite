...
module op_HLS_BUF_1024_I64W_O64W_ram_1024x64(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [9:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [63:0] R0_data,
...
module op_HLS_BUF_1024_I64W_O64W_Queue1024_UInt64(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_1024_I64W_O64W_ram_1024x64 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
...
module op_HLS_BUF_1024_I64W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  ...
  op_HLS_BUF_1024_I64W_O64W_Queue1024_UInt64 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
