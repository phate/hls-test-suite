...
module op_HLS_BUF_10_I64W_O64W_ram_10x64(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [63:0] R0_data,
...
module op_HLS_BUF_10_I64W_O64W_Queue10_UInt64(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_10_I64W_O64W_ram_10x64 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
...
module op_HLS_BUF_10_I64W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:229:7
  ...
  op_HLS_BUF_10_I64W_O64W_Queue10_UInt64 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:238:35
    .clock        (clk),
    .reset        (reset),
