...
module op_HLS_BUF_128_I64W_O64W_ram_128x64(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [6:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [63:0] R0_data,
...
module op_HLS_BUF_128_I64W_O64W_Queue128_UInt64(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_128_I64W_O64W_ram_128x64 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_128_I64W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_128_I64W_O64W_Queue128_UInt64 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
