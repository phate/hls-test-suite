...
module op_HLS_BUF_1_I2W_O2W_Queue1_UInt2(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  reg [1:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:44
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:60:7
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][2:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:44, :76:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module op_HLS_BUF_1_I2W_O2W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_1_I2W_O2W_Queue1_UInt2 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
