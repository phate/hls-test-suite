...
module op_HLS_BUF_20_I16W_O16W_ram_20x16(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [15:0] R0_data,
...
module op_HLS_BUF_20_I16W_O16W_Queue20_UInt16(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_20_I16W_O16W_ram_20x16 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? (deq_ptr_value == 5'h13 ? 5'h0 : deq_ptr_value + 5'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .R0_data (io_deq_bits),
...
module op_HLS_BUF_20_I16W_O16W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:229:7
  ...
  op_HLS_BUF_20_I16W_O16W_Queue20_UInt16 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:238:35
    .clock        (clk),
    .reset        (reset),
