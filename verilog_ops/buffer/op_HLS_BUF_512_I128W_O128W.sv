...
module op_HLS_BUF_512_I128W_O128W_ram_512x128(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [8:0]   R0_addr,
  input          R0_en,
                 R0_clk,
...
module op_HLS_BUF_512_I128W_O128W_Queue512_UInt128(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_512_I128W_O128W_ram_512x128 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr (do_deq ? ((&deq_ptr_value) ? 9'h0 : deq_ptr_value + 9'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .R0_data (io_deq_bits),
...
module op_HLS_BUF_512_I128W_O128W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  ...
  op_HLS_BUF_512_I128W_O128W_Queue512_UInt128 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
