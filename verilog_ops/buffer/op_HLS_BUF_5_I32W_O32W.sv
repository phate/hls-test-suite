...
module op_HLS_BUF_5_I32W_O32W_ram_5x32(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [2:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [31:0] R0_data,
  ...
  reg [31:0] Memory[0:4];	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_5_I32W_O32W_Queue5_UInt32(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_5_I32W_O32W_ram_5x32 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? (deq_ptr_value == 3'h4 ? 3'h0 : deq_ptr_value + 3'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .R0_data (io_deq_bits),
  ...
  assign io_count =
    ptr_match
      ...
      : deq_ptr_value > enq_ptr_value ? _ptr_diff_T - 3'h3 : _ptr_diff_T;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :76:27, :77:33, :126:32, :131:20, :133:10, :134:{10,25,57}
endmodule

module op_HLS_BUF_5_I32W_O32W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_5_I32W_O32W_Queue5_UInt32 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
