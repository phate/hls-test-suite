...
module op_HLS_BUF_8_I128W_O128W_ram_8x128(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [2:0]   R0_addr,
  input          R0_en,
                 R0_clk,
...
module op_HLS_BUF_8_I128W_O128W_Queue8_UInt128(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_8_I128W_O128W_ram_8x128 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr (do_deq ? ((&deq_ptr_value) ? 3'h0 : deq_ptr_value + 3'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .R0_data (io_deq_bits),
...
module op_HLS_BUF_8_I128W_O128W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_8_I128W_O128W_Queue8_UInt128 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
