...
module op_HLS_BUF_P_1024_I128W_O128W_ram_1024x128(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [9:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [127:0] Memory[0:1023];	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg         _R0_en_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg [9:0]   _R0_addr_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [10:0] i = 11'h0; i < 11'h400; i += 11'h1) begin
          ...
          Memory[i[9:0]] = _RANDOM_MEM;	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        ...
        _R0_addr_d0 = _RANDOM[10:1];	// src/main/scala/chisel3/util/Queue.scala:73:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module op_HLS_BUF_P_1024_I128W_O128W_Queue1024_UInt128(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  output [10:0]  io_count	// src/main/scala/chisel3/util/Queue.scala:72:14
);
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      if (do_enq)	// src/main/scala/chisel3/util/Queue.scala:80:27, :115:17, :118:{26,35}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        enq_ptr_value <= enq_ptr_value + 10'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
      if (do_deq)	// src/main/scala/chisel3/util/Queue.scala:81:27, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        deq_ptr_value <= deq_ptr_value + 10'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:60:7
        ...
        enq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][9:0];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7
        deq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][19:10];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][20];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :76:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  op_HLS_BUF_P_1024_I128W_O128W_ram_1024x128 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? ((&deq_ptr_value) ? 10'h0 : deq_ptr_value + 10'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:81:27, :106:{27,42,84}, :107:33, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
...
module op_HLS_BUF_P_1024_I128W_O128W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  output         i0_ready,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:536:14
  input          i0_valid,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:536:14
  input  [127:0] i0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:536:14
  input          o0_ready,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:537:14
  output         o0_valid,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:537:14
  output [127:0] o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:537:14
  input          clk,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:538:15
                 reset	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:539:17
);

  op_HLS_BUF_P_1024_I128W_O128W_Queue1024_UInt128 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
    .io_enq_ready (i0_ready),
    .io_enq_valid (~reset & i0_valid),	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:544:22, :545:21, :546:30
    .io_enq_bits  (i0_data),
    .io_deq_ready (o0_ready),
    .io_deq_valid (o0_valid),
    .io_deq_bits  (o0_data),
    .io_count     (/* unused */)
  );	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
endmodule
