...
module op_HLS_BUF_P_1024_I16W_O16W_ram_1024x16(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [9:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [15:0] R0_data,
  ...
  reg [15:0] Memory[0:1023];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [10:0] i = 11'h0; i < 11'h400; i += 11'h1) begin
          ...
          Memory[i[9:0]] = _RANDOM_MEM[15:0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_1024_I16W_O16W_Queue1024_UInt16(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_1024_I16W_O16W_ram_1024x16 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
...
module op_HLS_BUF_P_1024_I16W_O16W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  ...
  input  [15:0] i0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:536:14
  ...
  output [15:0] o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:537:14
  ...
  op_HLS_BUF_P_1024_I16W_O16W_Queue1024_UInt16 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
