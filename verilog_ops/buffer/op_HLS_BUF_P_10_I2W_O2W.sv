...
module op_HLS_BUF_P_10_I2W_O2W_ram_10x2(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [3:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [1:0] R0_data,
  ...
  reg [1:0] Memory[0:9];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [3:0] i = 4'h0; i < 4'hA; i += 4'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[1:0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_10_I2W_O2W_Queue10_UInt2(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  wire [1:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:44
  ...
  op_HLS_BUF_P_10_I2W_O2W_ram_10x2 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
...
module op_HLS_BUF_P_10_I2W_O2W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:229:7
  ...
  input  [1:0] i0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:231:16
  ...
  output [1:0] o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:232:16
  ...
  op_HLS_BUF_P_10_I2W_O2W_Queue10_UInt2 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:238:35
    .clock        (clk),
    .reset        (reset),
