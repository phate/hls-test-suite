...
module op_HLS_BUF_P_128_I1W_O1W_ram_128x1(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [6:0] R0_addr,
  input        R0_en,
               R0_clk,
  output       R0_data,
  ...
  reg       Memory[0:127];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [7:0] i = 8'h0; i < 8'h80; i += 8'h1) begin
          ...
          Memory[i[6:0]] = _RANDOM_MEM[0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_128_I1W_O1W_Queue128_UInt1(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_128_I1W_O1W_ram_128x1 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_128_I1W_O1W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  input  i0_valid,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:524:14
         i0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:524:14
         o0_ready,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:525:14
  output o0_valid,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:525:14
         o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:525:14
  ...
  op_HLS_BUF_P_128_I1W_O1W_Queue128_UInt1 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
