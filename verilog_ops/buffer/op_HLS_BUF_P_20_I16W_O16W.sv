...
module op_HLS_BUF_P_20_I16W_O16W_ram_20x16(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [15:0] R0_data,
  ...
  reg [15:0] Memory[0:19];	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_20_I16W_O16W_Queue20_UInt16(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  wire [4:0]  _ptr_diff_T = enq_ptr_value - deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:126:32
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      if (do_enq)	// src/main/scala/chisel3/util/Queue.scala:80:27, :115:17, :118:{26,35}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        enq_ptr_value <= enq_ptr_value == 5'h13 ? 5'h0 : enq_ptr_value + 5'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}
      if (do_deq)	// src/main/scala/chisel3/util/Queue.scala:81:27, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        deq_ptr_value <= deq_ptr_value == 5'h13 ? 5'h0 : deq_ptr_value + 5'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}
  ...
  op_HLS_BUF_P_20_I16W_O16W_ram_20x16 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? (deq_ptr_value == 5'h13 ? 5'h0 : deq_ptr_value + 5'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:81:27, :106:{27,42,84}, :107:33, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
  ...
  assign io_count =
    ptr_match
      ? (maybe_full ? 5'h14 : 5'h0)
      : deq_ptr_value > enq_ptr_value ? _ptr_diff_T - 5'hC : _ptr_diff_T;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :76:27, :77:33, :126:32, :131:20, :133:10, :134:{10,25,57}
endmodule

module op_HLS_BUF_P_20_I16W_O16W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:229:7
  ...
  op_HLS_BUF_P_20_I16W_O16W_Queue20_UInt16 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:238:35
    .clock        (clk),
    .reset        (reset),
