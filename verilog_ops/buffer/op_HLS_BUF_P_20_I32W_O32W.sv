...
module op_HLS_BUF_P_20_I32W_O32W_ram_20x32(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [31:0] R0_data,
  ...
  reg [31:0] Memory[0:19];	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_20_I32W_O32W_Queue20_UInt32(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_20_I32W_O32W_ram_20x32 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
...
module op_HLS_BUF_P_20_I32W_O32W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:229:7
  ...
  op_HLS_BUF_P_20_I32W_O32W_Queue20_UInt32 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:238:35
    .clock        (clk),
    .reset        (reset),
