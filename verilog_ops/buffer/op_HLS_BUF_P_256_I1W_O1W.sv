...
module op_HLS_BUF_P_256_I1W_O1W_ram_256x1(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [7:0] R0_addr,
  input        R0_en,
               R0_clk,
  output       R0_data,
  ...
  reg       Memory[0:255];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_256_I1W_O1W_Queue256_UInt1(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_256_I1W_O1W_ram_256x1 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_256_I1W_O1W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_P_256_I1W_O1W_Queue256_UInt1 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
