...
module op_HLS_BUF_P_32_I2W_O2W_ram_32x2(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [4:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [1:0] R0_data,
  ...
  reg [1:0] Memory[0:31];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM[1:0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_32_I2W_O2W_Queue32_UInt2(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_32_I2W_O2W_ram_32x2 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_32_I2W_O2W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:521:7
  ...
  op_HLS_BUF_P_32_I2W_O2W_Queue32_UInt2 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:531:27
    .clock        (clk),
    .reset        (reset),
