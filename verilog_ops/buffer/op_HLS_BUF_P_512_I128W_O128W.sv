...
module op_HLS_BUF_P_512_I128W_O128W_ram_512x128(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [8:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [127:0] Memory[0:511];	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg         _R0_en_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg [8:0]   _R0_addr_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [9:0] i = 10'h0; i < 10'h200; i += 10'h1) begin
          ...
          Memory[i[8:0]] = _RANDOM_MEM;	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        ...
        _R0_addr_d0 = _RANDOM[9:1];	// src/main/scala/chisel3/util/Queue.scala:73:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module op_HLS_BUF_P_512_I128W_O128W_Queue512_UInt128(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  output [9:0]   io_count	// src/main/scala/chisel3/util/Queue.scala:72:14
);
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:60:7
        ...
        enq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][8:0];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7
        deq_ptr_value = _RANDOM[/*Zero width*/ 1'b0][17:9];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][18];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :76:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  op_HLS_BUF_P_512_I128W_O128W_ram_512x128 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr (do_deq ? ((&deq_ptr_value) ? 9'h0 : deq_ptr_value + 9'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:81:27, :106:{27,42,84}, :107:33, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
...
module op_HLS_BUF_P_512_I128W_O128W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  ...
  op_HLS_BUF_P_512_I128W_O128W_Queue512_UInt128 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
