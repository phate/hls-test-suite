...
module op_HLS_BUF_P_512_I8W_O8W_ram_512x8(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [8:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [7:0] R0_data,
  ...
  reg [7:0] Memory[0:511];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [9:0] i = 10'h0; i < 10'h200; i += 10'h1) begin
          ...
          Memory[i[8:0]] = _RANDOM_MEM[7:0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_512_I8W_O8W_Queue512_UInt8(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_BUF_P_512_I8W_O8W_ram_512x8 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_BUF_P_512_I8W_O8W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:533:7
  ...
  op_HLS_BUF_P_512_I8W_O8W_Queue512_UInt8 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:543:27
    .clock        (clk),
    .reset        (reset),
