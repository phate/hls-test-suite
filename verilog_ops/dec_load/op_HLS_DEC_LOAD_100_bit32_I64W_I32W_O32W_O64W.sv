...
module op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_ram_100x32(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [6:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [31:0] R0_data,
  ...
  reg [31:0] Memory[0:99];	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_Queue100_UInt32(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      if (do_enq)	// src/main/scala/chisel3/util/Queue.scala:80:27, :115:17, :118:{26,35}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        enq_ptr_value <= enq_ptr_value == 7'h63 ? 7'h0 : enq_ptr_value + 7'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}
      if (do_deq)	// src/main/scala/chisel3/util/Queue.scala:81:27, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
        deq_ptr_value <= deq_ptr_value == 7'h63 ? 7'h0 : deq_ptr_value + 7'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}
  ...
  op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_ram_100x32 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr
      (do_deq ? (deq_ptr_value == 7'h63 ? 7'h0 : deq_ptr_value + 7'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:81:27, :106:{27,42,84}, :107:33, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
...
module op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_Queue100_Bool(	// src/main/scala/chisel3/util/Queue.scala:60:7
  input        clock,	// src/main/scala/chisel3/util/Queue.scala:60:7
               reset,	// src/main/scala/chisel3/util/Queue.scala:60:7
  output       io_enq_ready,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input        io_enq_valid,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  wire       do_enq = ~(empty & io_deq_ready) & ~full & io_enq_valid;	// src/main/scala/chisel3/util/Queue.scala:78:25, :79:24, :80:27, :103:19, :115:17, :118:{26,35}, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
  wire [6:0] _ptr_diff_T = enq_ptr_value - deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:126:32
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      enq_ptr_value <= 7'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40
      deq_ptr_value <= 7'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40
  ...
  assign io_count =
    ptr_match
      ? (maybe_full ? 7'h64 : 7'h0)
      : deq_ptr_value > enq_ptr_value ? _ptr_diff_T - 7'h1C : _ptr_diff_T;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :76:27, :77:33, :126:32, :131:20, :133:10, :134:{10,25,57}
endmodule

module op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:555:7
  ...
  op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_Queue100_UInt32 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:566:25
    .clock        (clk),
    .reset        (reset),
  ...
  op_HLS_DEC_LOAD_100_bit32_I64W_I32W_O32W_O64W_Queue100_Bool request_in_flight (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:573:37
    .clock        (clk),
    .reset        (reset),
