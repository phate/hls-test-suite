...
module op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_ram_128x8(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [6:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [7:0] R0_data,
  ...
  reg [7:0] Memory[0:127];	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [7:0] i = 8'h0; i < 8'h80; i += 8'h1) begin
          ...
          Memory[i[6:0]] = _RANDOM_MEM[7:0];	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_Queue128_UInt8(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_ram_128x8 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
...
module op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_Queue128_Bool(	// src/main/scala/chisel3/util/Queue.scala:60:7
  input        clock,	// src/main/scala/chisel3/util/Queue.scala:60:7
               reset,	// src/main/scala/chisel3/util/Queue.scala:60:7
  output       io_enq_ready,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input        io_enq_valid,	// src/main/scala/chisel3/util/Queue.scala:72:14
...
module op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:555:7
  ...
  input  [7:0]  i1_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:559:14
  ...
  output [7:0]  o0_data,	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:560:14
  ...
  op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_Queue128_UInt8 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:566:25
    .clock        (clk),
    .reset        (reset),
  ...
  op_HLS_DEC_LOAD_128_bit8_I64W_I8W_O8W_O64W_Queue128_Bool request_in_flight (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:573:37
    .clock        (clk),
    .reset        (reset),
