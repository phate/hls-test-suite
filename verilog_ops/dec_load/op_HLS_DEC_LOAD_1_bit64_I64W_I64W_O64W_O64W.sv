...
module op_HLS_DEC_LOAD_1_bit64_I64W_I64W_O64W_O64W_Queue1_UInt64(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  reg  [63:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:44
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:60:7
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][0]};	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:44, :76:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module op_HLS_DEC_LOAD_1_bit64_I64W_I64W_O64W_O64W_Queue1_Bool(	// src/main/scala/chisel3/util/Queue.scala:60:7
  input  clock,	// src/main/scala/chisel3/util/Queue.scala:60:7
         reset,	// src/main/scala/chisel3/util/Queue.scala:60:7
  output io_enq_ready,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  io_enq_valid,	// src/main/scala/chisel3/util/Queue.scala:72:14
...
module op_HLS_DEC_LOAD_1_bit64_I64W_I64W_O64W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:555:7
  ...
  op_HLS_DEC_LOAD_1_bit64_I64W_I64W_O64W_O64W_Queue1_UInt64 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:566:25
    .clock        (clk),
    .reset        (reset),
  ...
  op_HLS_DEC_LOAD_1_bit64_I64W_I64W_O64W_O64W_Queue1_Bool request_in_flight (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:573:37
    .clock        (clk),
    .reset        (reset),
