...
module op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_ram_4x128(	// src/main/scala/chisel3/util/Queue.scala:73:44
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [127:0] Memory[0:3];	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg         _R0_en_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
  reg [1:0]   _R0_addr_d0;	// src/main/scala/chisel3/util/Queue.scala:73:44
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:44
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          ...
          Memory[i[1:0]] = _RANDOM_MEM;	// src/main/scala/chisel3/util/Queue.scala:73:44
        end
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:73:44
        ...
        _R0_addr_d0 = _RANDOM[2:1];	// src/main/scala/chisel3/util/Queue.scala:73:44
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
module op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_Queue4_UInt128(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_ram_4x128 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
    .R0_addr (do_deq ? ((&deq_ptr_value) ? 2'h0 : deq_ptr_value + 2'h1) : deq_ptr_value),	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:81:27, :106:{27,42,84}, :107:33, :115:17, :117:14, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    .R0_en   (1'h1),
    .R0_clk  (clock),
...
module op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_Queue4_Bool(	// src/main/scala/chisel3/util/Queue.scala:60:7
  input        clock,	// src/main/scala/chisel3/util/Queue.scala:60:7
               reset,	// src/main/scala/chisel3/util/Queue.scala:60:7
  output       io_enq_ready,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input        io_enq_valid,	// src/main/scala/chisel3/util/Queue.scala:72:14
...
module op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W(	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:555:7
  ...
  op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_Queue4_UInt128 queue (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:566:25
    .clock        (clk),
    .reset        (reset),
  ...
  op_HLS_DEC_LOAD_4_fixedvector_bit32_4__I64W_I128W_O128W_O64W_Queue4_Bool request_in_flight (	// git/chisel-template/src/main/scala/hls_float/hls_float.scala:573:37
    .clock        (clk),
    .reset        (reset),
